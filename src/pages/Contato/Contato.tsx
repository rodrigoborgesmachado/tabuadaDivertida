function Contato() {
    return (
        <div className="global-pageContainer-left">
            ...
            <p className="global-mt">
                🛠️ <strong>GitHub:</strong> <a href="https://github.com/rodrigoborgesmachado" target="_blank" rel="noreferrer">github.com/rodrigoborgesmachado</a>
            </p>
            <p className="global-mt">
                Obrigado por utilizar o Tabuada Divertida! 😊
            </p>
        </div>
    );
}
